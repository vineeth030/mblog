<template>
    <AdminLayout>
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Editorial</h1>
                <p class="text-sm text-gray-500 mt-0.5">{{ posts.total }} editorial post{{ posts.total !== 1 ? 's' : '' }} total</p>
            </div>
            <Link
                :href="route('admin.editorial-posts.create')"
        ...
        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
            ...
            <div v-if="posts.data.length === 0" class="text-center py-16">
                ...
                <p class="mt-3 text-sm text-gray-500">No editorial posts yet.</p>
                <Link :href="route('admin.editorial-posts.create')" class="mt-3 inline-block text-sm text-indigo-600 hover:text-indigo-800 font-medium">
            ...
            <table v-else class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-200 bg-gray-50 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">
                        ...
                        <th class="px-4 py-3 hidden md:table-cell">Featured</th>
                        <th class="px-4 py-3 hidden lg:table-cell">Published</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    >
                        ...
                        <td class="px-4 py-3">
                            ...
                            <p class="text-xs text-gray-400 mt-0.5">/editorial/{{ post.slug }}</p>
                        </td>
                        ...
                        <td class="px-4 py-3 hidden sm:table-cell">
                            ...
                            >
                                <span
                                    ...
                                    :class="post.status === 'published' ? 'bg-green-500' : 'bg-gray-400'"
                                />
                        ...
                        <td class="px-4 py-3 hidden md:table-cell">
                            <span v-if="post.is_featured" class="text-xs font-medium text-amber-600">★ Featured</span>
                        ...
                        <td class="px-4 py-3 text-right whitespace-nowrap">
                            <Link
                                :href="route('admin.editorial-posts.edit', post.slug)"
...
function deletePost(post) {
    ...
    router.delete(route('admin.editorial-posts.destroy', post.slug));
}
</script>
